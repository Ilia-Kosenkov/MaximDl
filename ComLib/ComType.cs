...
namespace MaxImDL
{
    ...
    public abstract class ComType : IDisposable
    {
        ...
        protected ComType(Type type)
            => Type = type.IsCOMObject
                ? type
                : throw new ArgumentException("Provided type is not COM type.", nameof(type));
        ...
        protected void InvokeSetter(string name, object arg)
        {
            ...
            Type.InvokeMember(name,
                System.Reflection.BindingFlags.SetProperty | System.Reflection.BindingFlags.Instance, null, ComInstance,
                new[] {arg});
        }
        ...
        protected object? InvokeGetter(string name)
        {
            ...
            return Type.InvokeMember(name,
                System.Reflection.BindingFlags.GetProperty | System.Reflection.BindingFlags.Instance, null, ComInstance,
                Array.Empty<object>());
        }
        ...
        protected T FromGetter<T>([System.Runtime.CompilerServices.CallerMemberName]
            string prop = "")
            => (T) (InvokeGetter(prop) ??
                    throw new InvalidOperationException($"Unexpected property ({prop}) return value."));

        protected void FromSetter<T>(T value, [System.Runtime.CompilerServices.CallerMemberName]
            string prop = "")
